        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                    ...
                    <form action="{{ route('school-save-update') }}" method="POST"  enctype="multipart/form-data" >
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <input type="text" name="contact" id="contact" class="form-control @error('contact') is-invalid @enderror" value="{{ old('contact') ?? $item->contact }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                ...
                                                <input type="text" name="phone_main" id="phone_main" class="form-control @error('phone_main') is-invalid @enderror" value="{{ old('phone_main') ?? $item->phone_main }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                ...
                                                <input type="text" name="phone_secondary" id="phone_secondary" class="form-control" value="{{ old('phone_secondary') ?? $item->phone_secondary }}">
                                            </div>

                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                <label for="email_main">Correo principal:</label>
                                                <input type="text" name="email_main" id="email_main" class="form-control @error('email_main') is-invalid @enderror" value="{{ old('email_main') ?? $item->email_main }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                ...
                                                <input type="text" name="email_secondary" id="email_secondary" class="form-control" value="{{ old('email_secondary') ?? $item->email_secondary }}">
                                            </div>

                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                <label for="facebook">Facebook:</label>
                                                <input type="text" name="facebook" id="facebook" class="form-control" value="{{ old('facebook') ?? $item->facebook }}">
                                            </div>

                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                <label for="instagram">Instagram:</label>
                                                <input type="text" name="instagram" id="instagram" class="form-control" value="{{ old('instagram') ?? $item->instagram }}">
                                            </div>

                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                <label for="twitter">Twitter:</label>
                                                <input type="text" name="twitter" id="twitter" class="form-control" value="{{ old('twitter') ?? $item->twitter }}">
                                            </div>

                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                <label for="youtube">Youtube:</label>
                                                <input type="text" name="youtube" id="youtube" class="form-control" value="{{ old('youtube') ?? $item->youtube }}">
                                            </div>

                                            <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 form-group">
                                                <label for="years_experience">Años de experiencia:</label>
                                                <input type="number" name="years_experience" id="years_experience" class="form-control" value="{{ old('years_experience') ?? $item->years_experience }}">
                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9 form-group">
                                                ...
                                                <input type="text" name="mail_recipients" id="mail_recipients" class="form-control" value="{{ old('mail_recipients') ?? $item->mail_recipients }}">
                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <input type="text" name="meta_description" id="meta_description" class="form-control @error('meta_description') is-invalid @enderror" value="{{ old('meta_description') ?? $item->meta_description }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <span class="btn btn-primary btn-file elevation-2 btnFileOne" onchange="uploadImageOne()" data-action="btn-upload" data-input-url="logo_url" data-preview-image="logo_preview">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <input class="form-control @error('logo_url') is-invalid @enderror" name="logo_url" readonly="readonly" id="logo_url" type="text" value="{{ old('logo_url') ?? $item->logo_url }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4 mb-lg-0 text-center">
                                                ...
                                                <img
                                                    src="{{ old('logo_url') ?? $item->logo_url }}"
                                                    id="logo_preview"
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                <label for="meta_keywords">Footer (Logo)</label>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <input type="color" name="background_color_about_us" id="background_color_about_us" class="form-control @error('background_color_about_us') is-invalid @enderror" value="{{ old('background_color_about_us') ?? $item->background_color_about_us }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <input type="text" name="title_about_us" id="title_about_us" class="form-control @error('title_about_us') is-invalid @enderror" value="{{ old('title_about_us') ?? $item->title_about_us }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <textarea name="description_about_us" id="description_about_us" class="form-control @error('description_about_us') is-invalid @enderror" rows="3">{{ old('description_about_us') ?? $item->description_about_us }}</textarea>
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <textarea name="mission_about_us" id="mission_about_us" class="form-control @error('mission_about_us') is-invalid @enderror" rows="3">{{ old('mission_about_us') ?? $item->mission_about_us }}</textarea>
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <textarea name="vision_about_us" id="vision_about_us" class="form-control @error('vision_about_us') is-invalid @enderror" rows="3">{{ old('vision_about_us') ?? $item->vision_about_us }}</textarea>
                                                @error('vision_about_us')<span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong></span>@enderror
                                            </div>

                                            {{--<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                <label>Imágen "nosotros": ( 2240x850 píxeles )*</label>
                                                <div class="input-group">
                                                    <label class="input-group-btn">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <input class="form-control @error('image_about_us_url') is-invalid @enderror" name="image_about_us_url" readonly="readonly" id="image_about_us_url" type="text" value="{{ old('image_about_us_url') ?? $item->image_about_us_url }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4 mb-lg-0 text-center">
                                                ...
                                                <img
                                                    src="{{ old('image_about_us_url') ?? $item->image_about_us_url }}"
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                ...
                                                <textarea name="notice_privacy" id="notice_privacy" class="form-control form-group tiny-editor">{{ old('notice_privacy') ?? $item->notice_privacy }}</textarea>
                                            </div>
