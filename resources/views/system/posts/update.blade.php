                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ $item->title }}" oninput="generateSlug('title', 'slug')" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <input class="form-control @error('image_feature_url') is-invalid @enderror" name="image_feature_url" readonly="readonly" id="image_feature_url" type="text" value="{{ $item->image_feature_url ?? old('image_feature_url') }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4 mb-lg-0 text-center">
                                                ...
                                                <img
                                                    src="{{ $item->image_feature_url ?? old('image_feature_url') }}"
