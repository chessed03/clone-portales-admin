        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                    ...
                    <form action="{{ route('certification-save-update') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div  class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                    <label>Imagen: ( 197x148 píxeles )*</label>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4 mb-lg-0 text-center">
                                                    ...
                                                    <img
                                                        src="{{ old('image_url') ?? $item->image_url ?? asset('template/admin/img/sitio/site-working-none.png') }}"
                                                        id="image_preview"
