        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                    ...
                    <form action="{{ route('program-save-update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                            ...
                                            <div  class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                        ...
                                                        <input type="text" name="level" id="level" class="form-control @error('level') is-invalid @enderror" value="{{ old('level') ?? $item->level }}">
                                                        @error('level')<span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong></span>@enderror
                                                    </div>

                                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                        <label for="area">Área:</label>
                                                        <input type="text" name="area" id="area" class="form-control @error('area') is-invalid @enderror" value="{{ old('area') ?? $item->area }}">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                        ...
                                                        <input type="text" name="duration" id="duration" class="form-control @error('duration') is-invalid @enderror" value="{{ old('duration') ?? $item->duration }}">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <textarea name="content" id="content" class="form-control form-group tiny-editor">{{ old('content') ?? $item->content }}</textarea>
                                    </div>
