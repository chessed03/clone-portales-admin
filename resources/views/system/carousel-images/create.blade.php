        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                    ...
                    <form id="carousel-image-save-create" action="{{ route('carousel-image-save-create') }}" method="POST">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <textarea class="tiny-editor form-control" style="width: 100%;" rows="10" name="content">{!! old('content') !!}</textarea>
                                            </div>

                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                <label for="content_movil">Texto para la imagen móvil</label>
                                                <textarea class="tiny-editor form-control" style="width: 100%;" rows="10" name="content_movil">{!! old('content_movil') !!}</textarea>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <input class="form-control @error('image_movil_url') is-invalid @enderror" name="image_movil_url" readonly="readonly" id="image_movil_url" type="text" value="{{ old('image_movil_url') }}">
...
@section('scripts')
    ...
    <script>
        ...
        const submitForm = () => {
            ...
            $('#carousel-image-save-create').submit();
