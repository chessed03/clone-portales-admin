        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                    ...
                    <form action="{{ route('bannerOneInformation-save-create') }}" method="POST">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                    ...
                                                    <input type="text" name="title_quality_one" id="title_quality_one" class="form-control @error('title_quality_one') is-invalid @enderror" value="{{ old('title_quality_one') }}">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 form-group">
                                                    ...
                                                    <input type="text" name="icon_quality_one" id="icon_quality_one" class="form-control @error('icon_quality_one') is-invalid @enderror" value="{{ old('icon_quality_one') }}">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9 form-group">
                                                    ...
                                                    <input type="text" name="subtitle_quality_one" id="subtitle_quality_one" class="form-control @error('subtitle_quality_one') is-invalid @enderror" value="{{ old('subtitle_quality_one') }}">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                    ...
                                                    <input type="text" name="title_quality_two" id="title_quality_two" class="form-control" value="{{ old('title_quality_two') }}">
                                                </div>

                                                <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 form-group">
                                                    <label for="icon_quality_two">Icono calidad dos:</label>
                                                    <input type="text" name="icon_quality_two" id="icon_quality_two" class="form-control" value="{{ old('icon_quality_two') }}">
                                                </div>

                                                <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9 form-group">
                                                    <label for="subtitle_quality_two">Sub-título calidad dos:</label>
                                                    <input type="text" name="subtitle_quality_two" id="subtitle_quality_two" class="form-control" value="{{ old('subtitle_quality_two') }}">
                                                </div>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                    ...
                                                    <input type="text" name="title_quality_three" id="title_quality_three" class="form-control" value="{{ old('title_quality_three') }}">
                                                </div>

                                                <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 form-group">
                                                    <label for="icon_quality_three">Icono calidad tres:</label>
                                                    <input type="text" name="icon_quality_three" id="icon_quality_three" class="form-control" value="{{ old('icon_quality_three') }}">
                                                </div>

                                                <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9 form-group">
                                                    <label for="subtitle_quality_three">Sub-título calidad tres:</label>
                                                    <input type="text" name="subtitle_quality_three" id="subtitle_quality_three" class="form-control" value="{{ old('subtitle_quality_three') }}">
                                                </div>
