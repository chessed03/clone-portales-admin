                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                ...
                                                <input type="color" name="primary_color" id="primary_color" class="form-control" value="{{ old('primary_color') ?? "#bc044c" }}">
                                            </div>

                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                <label for="secondary_color">Color secundario:</label>
                                                <input type="color" name="secondary_color" id="secondary_color" class="form-control" value="{{ old('secondary_color') ?? "#125875" }}">
                                            </div>


                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                <label for="meta_keywords">Footer (Logo)</label>
                                                <input type="file" required name="footer_logo" id="file" class="form-control ">
