                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                        <label for="start_date">Fecha de inicio:</label>
                                                          <div class="input-group date datetime-input" id="start_date" data-target-input="nearest">
                                                              <input type="text" name="start_date" class="form-control datetimepicker-input @error('start_date') is-invalid @enderror" value="{{ old('start_date') }}" data-target="#start_date"/>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                        <label for="finish_date">Fecha de cierre:</label>
                                                          <div class="input-group date datetime-input" id="finish_date" data-target-input="nearest">
                                                              <input type="text" name="finish_date" class="form-control datetimepicker-input @error('finish_date') is-invalid @enderror" value="{{ old('finish_date') }}" data-target="#finish_date"/>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                        <div id="discount-price-component" data-has_cost="{{ old('input_has_cost') }}" data-input_value_price="{{ old('input_value_price') }}" data-select_value_discount="{{ old('select_value_discount') }}"></div>
                                                    </div>
                                                    ...
                                                    <input type="text" name="input_value_price" id="input_value_price" value="{{ old('input_value_price') }}" hidden>
                                                    <input type="text" name="select_value_discount" id="select_value_discount" value="{{ old('select_value_discount') }}" hidden>
                                                    <input type="text" name="input_has_cost" id="input_has_cost" value="{{ old('input_has_cost') ?? 0 }}" hidden>

                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group text-right" hidden>
                                                        <div class="custom-control custom-switch custom-switch-on-success">
                                                            <input type="checkbox" class="custom-control-input check-notice" name="launch_notice" id="launch_notice" value="1" {{ ( old('launch_notice') == 1 ) ? 'checked' : '' }}>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <span class="btn btn-primary btn-file elevation-2 btnFileTwo" onchange="uploadImageTwo()" data-action="btn-upload" data-input-url="image_banner_url" data-preview-image="image_about_us_preview">
                                                        <i class='bx bx-fw bx-cloud-upload btn-upload'></i> Cargar imágen <input accept=".jpg,.png,.jpeg,.gif" class="hidden" name="upload_image_two" type="file" id="upload_image_two">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <input class="form-control @error('image_banner_url') is-invalid @enderror" name="image_banner_url" readonly="readonly" id="image_banner_url" type="text" value="{{ old('image_banner_url') }}">
