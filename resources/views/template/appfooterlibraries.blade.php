...
<script src="{{ asset('template/admin/plugins/moment/locales.min.js') }}"></script>
...
<script src="{{ asset('template/admin/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js') }}"></script>
...
<script src="{{ asset('template/admin/plugins/tinymce/tinymce.min.js') }}"></script>

<script src="{{ asset('scripts/globals.blade.js') }}"></script>
