    ...
    <div class="card-header">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <h6>Lista de comentarrios de clientes</h6>
                ...
                @if( ___getAccessButton([]) )
                    ...
                    <a href="{{ route('clientTestimonial-create') }}">
                        <button class="btn btn-success elevation-2">
                            <i class="bx bx-fw bxs-plus-circle"></i> Nuevos comentarios
                        </button>
                    </a>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @foreach( $rows as $key => $row )
                            <tr>
                                <td>
                                    <a href="{{ route('clientTestimonial-update', [ 'id' => $row->id ]) }}" title="Editar elemento"> {{ $row->name }} </a>
                                </td>
                                ...
                                <td wire:key="{{ $row->id }}" class="text-right" wire:ignore>
                                    ...
                                    @if( ___getAccessButton( [ $row->school_id ] ) )
                                        ...
                                        <a class="btn btn-circle btn-primary elevation-2 mr-2" title="Editar" href="{{ route('clientTestimonial-update', [ 'id' => $row->id ]) }}">
