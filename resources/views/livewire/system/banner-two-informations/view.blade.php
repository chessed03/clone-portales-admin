    ...
    <div class="card-header">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <h6>Lista de Cintas informativas 2</h6>
            ...
            <div class="col-6 text-right">
                ...
                @if( ___getAccessButton( [] ) )
                    ...
                    <a href="{{ route('bannerTwoInformation-create') }}">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @foreach( $rows as $key => $row )
                                <tr>
                                    <td>
                                        <a href="{{ route('bannerTwoInformation-update', [ 'id' => $row->id ]) }}" title="Editar elemento"> {{ $row->title }} </a>
                                    </td>
                                    ...
                                    <td class="text-right" wire:key="dropdown-{{ $row->id }}">
                                        ...
                                        @if( ___getAccessButton( [ $row->school_id ] ) )
                                            ...
                                            <a class="btn btn-circle btn-primary elevation-2 mr-2" title="Editar" href="{{ route('bannerTwoInformation-update', [ 'id' => $row->id ]) }}">
