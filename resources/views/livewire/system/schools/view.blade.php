                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @foreach( $rows as $key => $row )
                            <tr>
                                <td>
                                    <a href="{{ route('school-update', [ 'id' => $row->id ]) }}" title="Editar elemento"> {{ $row->name }} </a>
                                </td>
                                <td >{{ $row->address }}</td>
                                <td wire:key="{{ $row->id }}" class="text-right" wire:ignore>
                                    ...
                                    @if( ___getAccessButton( [ $row->id ] ) )
                                        ...
                                        <a class="btn btn-circle btn-primary elevation-2 mr-2" title="Editar" href="{{ route('school-update', [ 'id' => $row->id ]) }}">
