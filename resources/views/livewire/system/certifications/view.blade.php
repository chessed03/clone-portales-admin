                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @foreach( $rows as $key => $row )
                                <tr>
                                    <td>
                                        <a href="{{ route('certification-update', [ 'id' => $row->id ]) }}" title="Editar elemento">  {{ $row->name }} </a>
                                    </td>
                                    ...
                                    <td wire:key="{{ $row->id }}" class="text-right" wire:ignore>
                                        ...
                                        @if( ___getAccessButton( [ $row->school_id ] ) )
                                            ...
                                            <a class="btn btn-circle btn-primary elevation-2 mr-2" title="Editar" href="{{ route('certification-update', [ 'id' => $row->id ]) }}">
